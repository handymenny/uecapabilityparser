    ...
    private val data = mapOf(
        ...
        Pair(
            50, arrayOf(
                ...
                BwNr(30, intArrayOf(10, 15, 20, 40, 50, 60, 80), intArrayOf(10, 15, 20, 40, 50, 60)),
                BwNr(60, intArrayOf(10, 15, 20, 40, 50, 60, 80), intArrayOf(10, 15, 20, 40, 50, 60))
            )
        ),
        Pair(
            51, arrayOf(
                BwNr(15, intArrayOf(5))
            )
        ),
        Pair(
            66, arrayOf(
        ...
        Pair(
            76, arrayOf(
                BwNr(15, intArrayOf(5), IntArray(0))
            )
        ),
