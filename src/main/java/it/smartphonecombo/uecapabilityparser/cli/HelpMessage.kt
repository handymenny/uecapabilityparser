...
object HelpMessage {
    ...
    const val MAX_THREADS =
        "Max number of threads to use for parallelized operations. The number of threads will never exceed 64 or the number of cores (whichever is lower)."
