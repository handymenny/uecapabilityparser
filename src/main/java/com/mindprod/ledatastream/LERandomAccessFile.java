...
public final class LERandomAccessFile implements DataInput, DataOutput {
   ...
   */
  private static final String EMBEDDED_COPYRIGHT = "Copyright: (c) 1999-2017 Roedy Green, Canadian Mind Products, http://mindprod.com";
   ...
   */
  public final synchronized void write(byte[] ba, int off, int len)
      throws IOException {
