...
public final class LERandomAccessFile implements DataInput, DataOutput {
     ...
     * @param rw like {@link java.io.RandomAccessFile} where "r" for read "rw" for read and write,
     *     "rws" for read-write sync, and "rwd" for read-write dsync. Sync ensures the physical I/O
     *     has completed befor the method returns.
    ...
    /**
     * Read an unsigned short, 16 bits. Like RandomAcessFile.readUnsignedShort except little endian.
     ...
     *
     * @param v char to write. like RandomAcessFile.writeChar. Note the parm is an int even though
     *     this as a writeChar
     * @throws IOException if read fails.
     */
    ...
    /**
     * Write a string, even though method called writeChars. like RandomAcessFile.writeChars, has to
     * flip each char.
     *
